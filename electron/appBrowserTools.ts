...
const APP_ROUTE_CATALOG: Array<{
  ...
  { path: '/settings/agents', description: 'AI Experts network (legacy/direct route).', requiresAuth: true },
  { path: '/settings/agents/new', description: 'Create a new AI expert profile.', requiresAuth: true },
