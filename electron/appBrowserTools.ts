...
const APP_ROUTE_CATALOG: Array<{
  ...
  { path: '/settings/agents', description: 'Settings — list of custom AI agents and their model assignments.', requiresAuth: true },
  { path: '/settings/agents/new', description: 'Settings — create a new AI agent (name, system prompt, image, provider, and model).', requiresAuth: true },
